#
# Sphinx configuration for AiiDA-OLCAO
#
...
copyright_owners = "Deepak Kumar Deo"
...
release = aiida_olcao.__version__
...
html_title = f"AiiDA-OLCAO v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://AiiDA-OLCAO.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "src", "aiida_olcao")
